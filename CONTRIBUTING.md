...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/SolaceSamples/PubSubCacheDocker/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/SolaceSamples/PubSubCacheDocker/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
* Search [GitHub](https://github.com/SolaceSamples/PubSubCacheDocker/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceSamples/PubSubCacheDocker) and clone your fork
locally.

```sh
git clone https://github.com/<my-github-repo>/PubSubCacheDocker
```
...
```sh
$ git remote add upstream https://github.com/SolaceSamples/PubSubCacheDocker
```
...
In GitHub, send a pull request to `PubSubCacheDocker:master`. 
...
* Open a GitHub [enhancement request issue](https://github.com/SolaceSamples/PubSubCacheDocker/issues/new) and describe the new functionality.
